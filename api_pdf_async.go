...
**Credits:** 1 credit deducted immediately (refunded if job fails permanently).
	...
	*/
	...
	/*
	GetPdfJobStatus Get PDF job status
...
- Consider using webhooks instead of polling
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param jobId
	@return PDFAsyncAPIGetPdfJobStatusRequest
	*/
	GetPdfJobStatus(ctx context.Context, jobId string) PDFAsyncAPIGetPdfJobStatusRequest

	// GetPdfJobStatusExecute executes the request
	//  @return JobStatusResponse
	GetPdfJobStatusExecute(r PDFAsyncAPIGetPdfJobStatusRequest) (*JobStatusResponse, *http.Response, error)
...
type PDFAsyncAPIGetPdfJobStatusRequest struct {
	ctx context.Context
	ApiService PDFAsyncAPI
	jobId string
}

func (r PDFAsyncAPIGetPdfJobStatusRequest) Execute() (*JobStatusResponse, *http.Response, error) {
	return r.ApiService.GetPdfJobStatusExecute(r)
}
...
- Consider using webhooks instead of polling
 ...
 @return PDFAsyncAPIGetPdfJobStatusRequest
*/
func (a *PDFAsyncAPIService) GetPdfJobStatus(ctx context.Context, jobId string) PDFAsyncAPIGetPdfJobStatusRequest {
	return PDFAsyncAPIGetPdfJobStatusRequest{
		ApiService: a,
		ctx: ctx,
		jobId: jobId,
...
// Execute executes the request
//  @return JobStatusResponse
func (a *PDFAsyncAPIService) GetPdfJobStatusExecute(r PDFAsyncAPIGetPdfJobStatusRequest) (*JobStatusResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PDFAsyncAPIService.GetPdfJobStatus")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/pdf/status/{job_id}"
