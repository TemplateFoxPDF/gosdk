...
// APIClient manages communication with the TemplateFox API API v1.10.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.PDFAsyncAPI = (*PDFAsyncAPIService)(&c.common)
	c.PDFToolsAPI = (*PDFToolsAPIService)(&c.common)
