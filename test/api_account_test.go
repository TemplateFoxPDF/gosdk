...
func Test_templatefox_AccountAPIService(t *testing.T) {
	...
	t.Run("Test AccountAPIService ListTransactions", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AccountAPI.ListTransactions(context.Background()).Execute()
