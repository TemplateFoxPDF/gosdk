...
func NewJobStatusResponse(id string, status AppRoutersV1PdfAsyncJobStatus, templateId string, exportType string, storeS3 bool, createdAt string, updatedAt string) *JobStatusResponse {
...
func (o *JobStatusResponse) GetStatus() AppRoutersV1PdfAsyncJobStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *JobStatusResponse) GetStatusOk() (*AppRoutersV1PdfAsyncJobStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JobStatusResponse) SetStatus(v AppRoutersV1PdfAsyncJobStatus) {
	o.Status = v
}
