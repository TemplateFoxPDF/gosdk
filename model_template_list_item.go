...
func (o *TemplateListItem) GetKind() string {
...
// and a boolean to check if the value has been set.
func (o *TemplateListItem) GetKindOk() (*string, bool) {
	if o == nil || IsNil(o.Kind) {
		return nil, false
	}
	return o.Kind, true
...
func (o *TemplateListItem) HasKind() bool {
	if o != nil && !IsNil(o.Kind) {
		return true
	}
...
func (o *TemplateListItem) SetKind(v string) {
	o.Kind = &v
}
